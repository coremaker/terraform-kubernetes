...
| <a name="input_egressgateway_values"></a> [egressgateway\_values](#input\_egressgateway\_values) | Values to be set on the egress gateway resource. | <pre>list(object({<br>    name  = optional(any)<br>    value = optional(any)<br>  }))</pre> | `[]` | no |
...
| <a name="input_ingressgateway_values"></a> [ingressgateway\_values](#input\_ingressgateway\_values) | Values to be set on the ingress gateway resource. | <pre>list(object({<br>    name  = optional(any)<br>    value = optional(any)<br>  }))</pre> | `[]` | no |
