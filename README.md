...
| <a name="input_egressgateway_values"></a> [egressgateway\_values](#input\_egressgateway\_values) | Values to be set on the egress gateway resource. | <pre>list(object({<br>    name  = any<br>    value = any<br>  }))</pre> | `[]` | no |
